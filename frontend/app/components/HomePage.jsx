        ...
        <div className="container mx-auto p-6">
            <div className="flex">
                <div className="w-1/2 p-4">
                    ...
                    <p className="text-gray-500 italic mb-4">You can use the following placeholders in your email template: {`{first_name}, {last_name}, {sender_name}, {sender_email}`}</p>
                    <div className="mb-4">
                        <input
                            type="text"
                ...
                <div className="w-1/2 p-4">
                    ...
                    <div className="mb-4 border border-gray-300 p-2" style={{ height: "350px", overflowY: "auto" }}>
